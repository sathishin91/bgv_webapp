							...
							<div class="row">
								<div class="col-md-6 col-sm-12 col-lg-6 col-xl-3">
									<div class="card text-center overflow-hidden">
										<img src="<?php echo base_url('assets/images/media/1.jpg'); ?>" alt="img">
										<div class="card-body">
								...
								<div class="col-md-6 col-sm-12 col-lg-6 col-xl-3">
									<div class="card text-center overflow-hidden">
										<img src="<?php echo base_url('assets/images/media/2.jpg'); ?>" alt="img">
										<div class="card-body">
								...
								<div class="col-md-6 col-sm-12 col-lg-6 col-xl-3">
									<div class="card text-center overflow-hidden">
										<img src="<?php echo base_url('assets/images/media/6.jpg'); ?>" alt="img">
										<div class="card-body">
								...
								<div class="col-md-6 col-sm-12 col-lg-6 col-xl-3">
									<div class="card text-center overflow-hidden">
										<img src="<?php echo base_url('assets/images/media/7.jpg'); ?>" alt="img">
										<div class="card-body">
