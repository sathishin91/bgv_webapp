						...
						<div class="app-sidebar bg-transparent horizontal-main">
							<div class="container">
								<div class="main-sidemenu navbar px-0">
									<a class="navbar-brand ps-0 d-none d-lg-block" href="<?php echo base_url('index'); ?>">
										<img alt="" class="logo-2" src="<?php echo base_url('assets/images/brand/logo-3.png'); ?>">
										<img alt="" class="dark-landinglogo" src="<?php echo base_url('assets/images/brand/logo.png'); ?>">
									</a>
							...
							<div class="overflow-hidden">
								<div class="row">
									...
									<div class="col-lg-6 text-left pos-relative overflow-hidden market-image">
										<img alt="" class="logo-2" src="<?php echo base_url('assets/images/landing/market.png'); ?>">
									</div>
								</div>
							</div>
						</div>
