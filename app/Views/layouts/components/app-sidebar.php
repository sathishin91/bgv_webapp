					...
					<div class="app-sidebar">
						...
						<div class="main-sidemenu">
							...
							<ul class="side-menu">
								...
								<!-- <li class="slide">
									<a class="side-menu__item has-link" data-bs-toggle="slide" href="<?php echo base_url('index'); ?>">
								...
								<li class="slide">
									<a class="side-menu__item has-link" data-bs-toggle="slide" href="<?php echo base_url('all-client'); ?>">
										<i class="fe fe-users side-menu__icon"></i>
										<span class="side-menu__label">All Clients</span>
									</a>
								</li>
								<li class="slide">
									<a class="side-menu__item has-link" data-bs-toggle="slide" href="<?php echo base_url('todo'); ?>">
										<i class="icon icon-list side-menu__icon"></i>
										<span class="side-menu__label">To do's</span>
									</a>
								</li>
								<li class="slide">
									<a class="side-menu__item has-link" data-bs-toggle="slide" href="<?php echo base_url('del-check'); ?>">
										<i class="fe fe-x-square side-menu__icon"></i>
										<span class="side-menu__label">Delete checks</span>
									</a>
								</li>
								<li class="slide">
									<a class="side-menu__item has-link" data-bs-toggle="slide" href="<?php echo base_url('add-client'); ?>">
										<i class="fe fe-user-plus side-menu__icon"></i>
										<span class="side-menu__label">Add Client</span>
									</a>
								</li>
								<!-- <li>
									<h3>Components</h3>
								...
								<!-- <li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a href="<?php echo base_url('form-elements'); ?>" class="slide-item">Form Elements</a></li>
										<li><a href="<?php echo base_url('form-layouts'); ?>" class="slide-item">Form Layouts</a></li>
										<li><a href="<?php echo base_url('form-validation'); ?>" class="slide-item">Form Validation</a></li>
										<li><a href="<?php echo base_url('form-advanced'); ?>" class="slide-item">Form Advanced</a></li>
										<li><a href="<?php echo base_url('wysiwyag'); ?>" class="slide-item">Form Editors</a></li>
										<li><a href="<?php echo base_url('form-editable'); ?>" class="slide-item">Form Editable</a></li>
										<li><a href="<?php echo base_url('form-wizard'); ?>" class="slide-item">Form Wizard</a></li>
									</ul>
								</li>
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="#">
									...
									<ul class="slide-menu">
										...
										<li><a href="<?php echo base_url('tables'); ?>" class="slide-item">Default Table</a></li>
										<li><a href="<?php echo base_url('datatable'); ?>" class="slide-item">Data Tables</a></li>
										<li><a href="<?php echo base_url('table-editable'); ?>" class="slide-item">Editable Tables</a></li>
									</ul>
								</li>
								<li class="slide">
									<a class="side-menu__item has-link" data-bs-toggle="slide" href="<?php echo base_url('landing'); ?>" target="_blank">
										<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
								...
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a href="<?php echo base_url('chart-chartjs'); ?>" class="slide-item">Chart Js</a></li>
								...
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a href="<?php echo base_url('calendar2'); ?>" class="slide-item">Calendar</a></li>
										<li><a href="<?php echo base_url('chat'); ?>" class="slide-item">Chat</a></li>
										<li class="sub-slide">
											<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span class="sub-side-menu__label">E-Commerce</span><i class="sub-angle fa fa-angle-right"></i></a>
											<ul class="sub-slide-menu">
												<li><a class="sub-slide-item" href="<?php echo base_url('cart'); ?>">Cart</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('checkout'); ?>">Checkout</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('products'); ?>">Products</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('product-details'); ?>">Product-Details</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('wishlist'); ?>">Wishlist</a></li>
											</ul>
										</li>
										<li class="sub-slide">
											...
											<ul class="sub-slide-menu">
												<li><a class="sub-slide-item" href="<?php echo base_url('file-manager'); ?>">Files</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('file-manager-1'); ?>">File Manager</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('file-manager-2'); ?>">File Details</a></li>
											</ul>
										</li>
										<li class="sub-slide">
											<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span class="sub-side-menu__label">E-Mail</span><i class="sub-angle fa fa-angle-right"></i></a>
											<ul class="sub-slide-menu">
												<li><a class="sub-slide-item" href="<?php echo base_url('mail-inbox'); ?>">Inbox</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('mail-compose'); ?>">Compose Mail</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('mail-read'); ?>">Read Mail</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('mail-settings'); ?>">Mail Settings</a></li>
											</ul>
										</li>
										<li class="sub-slide">
											<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span class="sub-side-menu__label">Invoices</span><i class="sub-angle fa fa-angle-right"></i></a>
											<ul class="sub-slide-menu">
												<li><a class="sub-slide-item" href="<?php echo base_url('invoice-list'); ?>">Invoice List</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('invoice-details'); ?>">Invoice Details</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('invoice-create'); ?>">Create Invoice</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('invoice-timelog'); ?>">Time Log Invoice</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('invoice-edit'); ?>">Edit Invoice</a></li>
											</ul>
										</li>
										<li class="sub-slide">
											<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span class="sub-side-menu__label">Projects</span><i class="sub-angle fa fa-angle-right"></i></a>
											<ul class="sub-slide-menu">
												<li><a class="sub-slide-item" href="<?php echo base_url('projects'); ?>">Projects</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('projects-list'); ?>">Projects List</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('project-details'); ?>">Project Details</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('project-new'); ?>">Project New</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('project-edit'); ?>">Edit Project</a></li>
											</ul>
										</li>
										<li><a href="<?php echo base_url('ticket-details'); ?>" class="slide-item"><span class="side-menu__label">Tickets</span></a></li>
										<li class="sub-slide">
											<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span class="sub-side-menu__label">Tasks</span><i class="sub-angle fa fa-angle-right"></i></a>
											<ul class="sub-slide-menu">
												<li><a class="sub-slide-item" href="<?php echo base_url('tasks-list'); ?>">Task List</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('task-edit'); ?>">Edit Task</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('task-create'); ?>">Create Task</a></li>
											</ul>
										</li>
										<li class="sub-slide">
											<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span class="sub-side-menu__label">Clients</span><i class="sub-angle fa fa-angle-right"></i></a>
											<ul class="sub-slide-menu">
												<li><a class="sub-slide-item" href="<?php echo base_url('clients'); ?>">Clients</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('client-create'); ?>">Add Client</a></li>
											</ul>
										</li>
									</ul>
								</li>
								...
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a href="<?php echo base_url('avatar'); ?>" class="slide-item">Avatar</a></li>
										<li><a href="<?php echo base_url('badge'); ?>" class="slide-item">Badges</a></li>
										...
										<li><a href="<?php echo base_url('dropdown'); ?>" class="slide-item">Dropdown</a></li>
										...
										<li><a href="<?php echo base_url('panels'); ?>" class="slide-item">Panels</a></li>
										<li><a href="<?php echo base_url('rangeslider'); ?>" class="slide-item">Range Slider</a></li>
										<li><a href="<?php echo base_url('scroll'); ?>" class="slide-item">Scroll</a></li>
								...
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a href="<?php echo base_url('carousel'); ?>" class="slide-item">Carousel</a></li>
										<li><a href="<?php echo base_url('cards'); ?>" class="slide-item">Cards</a></li>
										<li><a href="<?php echo base_url('counters'); ?>" class="slide-item">Counters</a></li>
										<li><a href="<?php echo base_url('modal'); ?>" class="slide-item">Modals</a></li>
										<li><a href="<?php echo base_url('timeline'); ?>" class="slide-item">Timeline</a></li>
										...
										<li><a href="<?php echo base_url('progress'); ?>" class="slide-item">Progress Bars</a></li>

										<li><a href="<?php echo base_url('footers'); ?>" class="slide-item">Footers</a></li>
										<li><a href="<?php echo base_url('users-list'); ?>" class="slide-item">Users List</a></li>
										<li><a href="<?php echo base_url('file-attachments'); ?>" class="slide-item">File Attachments</a></li>
									</ul>
								</li> -->
								<!-- <li>
									<h3>Pages</h3>
								...
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li class="sub-slide">
											<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span class="sub-side-menu__label">Authentication</span><i class="sub-angle fa fa-angle-right"></i></a>
											<ul class="sub-slide-menu">
												<li><a class="sub-slide-item" href="<?php echo base_url('login'); ?>">Sign In</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('register'); ?>">Sign Up</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('forgot-password'); ?>">Forgot Password</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('lockscreen'); ?>">Lockscreen</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('construction'); ?>">UnderConstruction</a></li>
											</ul>
										</li>
										<li class="sub-slide">
											<a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span class="sub-side-menu__label">Error Pages</span><i class="sub-angle fa fa-angle-right"></i></a>
											<ul class="sub-slide-menu">
												<li><a class="sub-slide-item" href="<?php echo base_url('error404'); ?>">404 Error</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('error500'); ?>">500 Error</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('error501'); ?>">501 Error</a></li>
											</ul>
										</li>
										<li><a href="<?php echo base_url('settings'); ?>" class="slide-item">Settings</a></li>
										<li><a href="<?php echo base_url('profile'); ?>" class="slide-item">Profile</a></li>
										<li><a href="<?php echo base_url('about'); ?>" class="slide-item">About Company</a></li>
										<li><a href="<?php echo base_url('services'); ?>" class="slide-item">Services</a></li>
										<li><a href="<?php echo base_url('switcher'); ?>" class="slide-item">Switcher</a></li>
										<li><a href="<?php echo base_url('terms'); ?>" class="slide-item">Terms</a></li>
										<li><a href="<?php echo base_url('faq'); ?>" class="slide-item">Faq's</a></li>
										<li><a href="<?php echo base_url('pricing'); ?>" class="slide-item">Pricing</a></li>
										<li class="sub-slide">
											...
											<ul class="sub-slide-menu">
												<li><a class="sub-slide-item" href="<?php echo base_url('blog'); ?>">Blog</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('blog-details'); ?>">Blog Details</a></li>
												<li><a class="sub-slide-item" href="<?php echo base_url('blog-edit'); ?>">Edit Post</a></li>
											</ul>
										</li>
									</ul>
								</li>
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a href="<?php echo base_url('background'); ?>" class="slide-item">Background</a></li>
										<li><a href="<?php echo base_url('border'); ?>" class="slide-item">Border</a></li>
										<li><a href="<?php echo base_url('display'); ?>" class="slide-item">Display</a></li>
										<li><a href="<?php echo base_url('flex'); ?>" class="slide-item">Flex</a></li>
										<li><a href="<?php echo base_url('height'); ?>" class="slide-item">Height</a></li>
										<li><a href="<?php echo base_url('margin'); ?>" class="slide-item">Margin</a></li>
										<li><a href="<?php echo base_url('padding'); ?>" class="slide-item">Padding</a></li>
										<li><a href="<?php echo base_url('position'); ?>" class="slide-item">Position</a></li>
										<li><a href="<?php echo base_url('width'); ?>" class="slide-item">Width</a></li>
										<li><a href="<?php echo base_url('opacity'); ?>" class="slide-item">Opacity</a></li>
										<li><a href="<?php echo base_url('empty'); ?>" class="slide-item">Empty Page</a></li>
									</ul>
								</li>
							</ul> -->
