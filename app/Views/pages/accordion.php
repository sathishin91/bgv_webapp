<?= $this->extend('layouts/main'); ?>
														...
														<div class="border p-3 br-bottom-radius-5">
															<div class="row">
																<div class="col-lg-3 col-md-6">
																	<img class="img-fluid br-5 my-1 my-sm-2" src="<?php echo base_url('assets/images/photos/8.jpg'); ?>" alt="banner image">
																</div>
																<div class="col-lg-3 col-md-6">
																	<img class="img-fluid br-5 my-1 my-sm-2" src="<?php echo base_url('assets/images/photos/10.jpg'); ?>" alt="banner image ">
																</div>
																<div class="col-lg-3 col-md-6">
																	<img class="img-fluid br-5 my-1 my-sm-2" src="<?php echo base_url('assets/images/photos/8.jpg'); ?>" alt="banner image ">
																</div>
																<div class="col-lg-3 col-md-6">
																	<img class="img-fluid br-5 my-1 my-sm-2" src="<?php echo base_url('assets/images/photos/12.jpg'); ?>" alt="banner image ">
																</div>
															</div>
														</div>
													</div>
	...
	<?= $this->section('scripts'); ?>
		...
		<script src="<?php echo base_url('assets/plugins/accordion/accordion.js'); ?>"></script>
