<?= $this->extend('layouts/main'); ?>
	...
	<?= $this->section('scripts'); ?>
		...
		<script src="<?php echo base_url('assets/plugins/bootstrap-editable/bootstrap-editable/js/bootstrap-editable.min.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/bootstrap-editable.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/address-editable.js'); ?>"></script>
