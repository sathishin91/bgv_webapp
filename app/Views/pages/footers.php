										...
										<div class="card-body">
											<div class="top-footer">
												<div class="row">
													...
													<div class="col-lg-4 col-md-4">
														<h6>Posts</h6>
														<img alt="" src="<?php echo base_url('assets/images/media/media1.jpg'); ?>">
														<img alt="" src="<?php echo base_url('assets/images/media/media2.jpg'); ?>">
														<img alt="" src="<?php echo base_url('assets/images/media/media3.jpg'); ?>">
														<img alt="" src="<?php echo base_url('assets/images/media/media4.jpg'); ?>">
														<hr>
