<?= $this->extend('layouts/main'); ?>
									...
									<div class="card">
										<div class="card-body p-4">
											<div class="d-flex align-items-center justify-content-between">
												...
												<div class="btn-list">
													<a class="btn btn-outline-primary" href="<?php echo base_url('projects'); ?>">
														...
														<tr>
															...
															<td>
																<div class="avatar-list avatar-list-stacked">
																	...
																	<span class="avatar bradius cover-image" data-bs-image-src= "<?php echo base_url('assets/images/users/8.jpg'); ?>"></span>
																	<span class="avatar bradius cover-image" data-bs-image-src= "<?php echo base_url('assets/images/users/11.jpg'); ?>"></span>
																	<span class="avatar bradius cover-image" data-bs-image-src= "<?php echo base_url('assets/images/users/12.jpg'); ?>"></span>
														...
														<tr>
															...
															<td>
																<div class="avatar-list avatar-list-stacked">
																	...
																	<span class="avatar bradius cover-image" data-bs-image-src= "<?php echo base_url('assets/images/users/11.jpg'); ?>"></span>
																	<span class="avatar bradius cover-image" data-bs-image-src= "<?php echo base_url('assets/images/users/9.jpg'); ?>"></span>
																	<span class="avatar bradius cover-image" data-bs-image-src= "<?php echo base_url('assets/images/users/5.jpg'); ?>"></span>
	...
	<?= $this->section('scripts'); ?>
		...
		<!-- PROJECT-LIST JS-->
		<script src="<?php echo base_url('assets/js/project-list.js'); ?>"></script>
