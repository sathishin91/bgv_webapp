<?= $this->extend('layouts/main'); ?>
								...
								<div class="col-12">
									<div class="card p-0">
										...
										<div class="card-footer ticket-details-footer p-0">
											...
											<div class="media ticket-reply">
												<div class="me-3">
													<a href="<?php echo base_url('profile'); ?>"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="<?php echo base_url('assets/images/users/13.jpg'); ?>"> </a>
												</div>
												<div class="media-body">
													<nav class="nav float-end">
														<div class="dropdown">
	...
	<?= $this->section('scripts'); ?>
		...
		<!-- TICKET DETAILS JS -->
		<script src="<?php echo base_url('assets/js/ticket-details.js'); ?>"></script>
