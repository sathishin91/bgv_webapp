								...
								<div class="col-xl-4 col-md-12">
									<div class="card cart">
										...
										<div class="card-body">
											<div class="d-md-flex">
												<div class="d-flex">
													<img class="img-fluid avatar-xl border p-0 br-7" src="<?php echo base_url('assets/images/pngs/9.png'); ?>" alt="img">
													<div class="ms-3 mt-2">
											...
											<div class="d-md-flex mt-5">
												<div class="d-flex">
													<img class="img-fluid avatar-xl border p-0 br-7" src="<?php echo base_url('assets/images/pngs/1.png'); ?>" alt="img">
													<div class="ms-3 mt-2">
											...
											<div class="d-md-flex mt-5">
												<div class="d-flex">
													<img class="img-fluid avatar-xl border p-0 br-7" src="<?php echo base_url('assets/images/pngs/6.png'); ?>" alt="img">
													<div class="ms-3 mt-2">
