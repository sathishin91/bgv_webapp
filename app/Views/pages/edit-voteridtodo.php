...
<form action="<?php echo base_url('EmployeeController/editVoterIdStatus') ?>" id="user_frm" method="post" enctype="multipart/form-data">
    <input type="hidden" class="form-control" id="id" name="id" value="<?= ($record) ? $record['id'] : '' ?>">

    <?php if ($record['is_voter_id'] == 1) {
        $status = "<span class='text-success'>approved</span>";
    } elseif ($record['is_voter_id'] == 2) {
    ...
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-3">
                <div style="text-align: left;">
                    <label for="first_name">VoterId number</label>
                    <h6 class="text-black text-bold"><?= $record['voter_id'] ?></h6>
                </div>
                                ...
                                <div class="col-6">
                                    <div class="selectgroup selectgroup-pills">
                                        <label class="selectgroup-item">
                                            ...
                                            <span class="selectgroup-button"><i class="mdi mdi-approval text-success"></i> voterid found</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-10">
                                    <div class="selectgroup selectgroup-pills">
                                        <label class="selectgroup-item">
                                            ...
                                            <span class="selectgroup-button"><i class="mdi mdi-close-circle text-danger"></i> voterid not found</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-10">
                                    <div class="selectgroup selectgroup-pills">
                                        <label class="selectgroup-item">
                                            ...
                                            <span class="selectgroup-button"><i class="mdi mdi-close-circle text-danger"></i> voterid found but name mismatched</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-10">
                                    <div class="selectgroup selectgroup-pills">
                                        <label class="selectgroup-item">
                                            ...
                                            <span class="selectgroup-button"><i class="mdi mdi-close-circle text-danger"></i> fake voterid</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
...
<script>
    $("#saveDataBtn").click(function() {
        ...
        // alert(value);
        if (value == 1) {
            var str = "<input type='radio' name='status' value='1' id='status' class='selectgroup-input' checked> <span class='selectgroup-button'><i class='mdi mdi-approval text-success'></i> voterid found</span>";
        } else if (value == 2) {
            ...
            var str = "<input type='radio' name='status' value='3' id='status' class='selectgroup-input' checked> <span class='selectgroup-button'><i class='mdi mdi-close-circle text-danger'></i> voterid not found</span>";
        } else if (value == 4) {
            var str = "<input type='radio' name='status' value='4' id='status' class='selectgroup-input' checked> <span class='selectgroup-button'><i class='mdi mdi-close-circle text-danger'></i> voterid found but name mismatched</span>";
        } else if (value == 5) {
            var str = "<input type='radio' name='status' value='5' id='status' class='selectgroup-input' checked> <span class='selectgroup-button'><i class='mdi mdi-close-circle text-danger'></i> fake voterid</span>";
        }
