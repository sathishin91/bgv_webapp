<?= $this->extend('layouts/main'); ?>
    ...
    <?= $this->section('content'); ?>
							...
							<div class="row">
								...
								<div class="col-md-12 mb-3">
									<div class="btn-list">
										<a href="<?php echo base_url('task-create'); ?>" class="btn btn-primary">
										...
										<a href="<?php echo base_url('task-edit'); ?>" class="btn btn-info">
	...
	<?= $this->section('scripts'); ?>
		...
		<!-- TASKS LIST JS-->
		<script src="<?php echo base_url('assets/js/tasks-list.js'); ?>"></script>
