								...
								<div class="col-md-12 col-lg-4 col-xl-3">
									<div class="card">
										<div class="card-header border-bottom">
											<a href="<?php echo base_url('mail-compose'); ?>" class="btn btn-block btn-outline-primary py-2">Compose</a>
										</div>
										<div class="card-body">
											...
											<ul class="nav1 nav-column flex-column br-7 mt-3">
												<li class="nav-item1 mt-0">
													<a class="nav-link thumb" href="<?php echo base_url('mail-settings'); ?>">
