												...
												<div class="card-body project-type-container projects p-4">
													...
													<div class="d-sm-flex align-items-center">
														<div class="btn-list mx-4">
															...
															<a class="btn btn-outline-primary" href="<?php echo base_url('projects-list'); ?>">
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1"> <a href="<?php echo base_url('project-details'); ?>" class="float-start">Web Design</a> <span class="text-muted bg-light fs-11 mx-2">opened yesterday</span> </h6>
																		...
																		<div class="row align-items-center">
																			<div class="col">
																				...
																				<div class="avatar-list avatar-list-stacked">
																					<span class="avatar bradius cover-image" data-bs-image-src= "<?php echo base_url('assets/images/users/9.jpg'); ?>"></span>
																					<span class="avatar bradius cover-image" data-bs-image-src= "<?php echo base_url('assets/images/users/8.jpg'); ?>"></span>
																					<span class="avatar bradius cover-image" data-bs-image-src= "<?php echo base_url('assets/images/users/11.jpg'); ?>"></span>
																					<span class="avatar bradius cover-image" data-bs-image-src= "<?php echo base_url('assets/images/users/1.jpg'); ?>"></span>
																					<span class="avatar bradius cover-image" data-bs-image-src= "<?php echo base_url('assets/images/users/6.jpg'); ?>"></span>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="<?php echo base_url('project-details'); ?>" class="float-start">Cloud Computing</a> <span class="text-muted bg-light fs-11 mx-2">opened 1min ago</span> </h6>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="<?php echo base_url('project-details'); ?>" class="float-start">SQL</a> <span class="text-muted bg-light fs-11 mx-2">opened 1mth ago</span> </h6>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="<?php echo base_url('project-details'); ?>" class="float-start">Ethical Hacking</a> <span class="text-muted bg-light fs-11 mx-2">opened 3d ago</span> </h6>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="<?php echo base_url('project-details'); ?>" class="float-start">Login Authentication</a> <span class="text-muted bg-light fs-11 mx-2">opened 1min ago</span> </h6>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="<?php echo base_url('project-details'); ?>" class="float-start">SEO Using React</a> <span class="text-muted bg-light fs-11 mx-2">opened 4mth ago</span> </h6>
																						<span class="text-muted border-end pe-2 fs-11 float-start mt-1">75 tasks</span>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="<?php echo base_url('project-details'); ?>" class="float-start">System Design</a> <span class="text-muted bg-light fs-11 mx-2">opened 2d ago</span> </h6>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="<?php echo base_url('project-details'); ?>" class="float-start">Database Administration</a> <span class="text-muted bg-light fs-11 mx-2">opened 3d ago</span> </h6>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="<?php echo base_url('project-details'); ?>" class="float-start">Web Design</a> <span class="text-muted bg-light fs-11 mx-2">opened yesterday</span> </h6>
																						<span class="text-muted border-end pe-2 fs-11 float-start mt-1">28 tasks</span>
																						<span class="text-teritary ps-1 fs-11">11 Nov 19</span>
																					</div>
																				</div>
																		...
																		<div class="row">
																			<div class="col">
																				<div class="d-sm-flex align-items-center">
																					...
																					<div class="ms-1">
																						<h6 class="mb-1 text-normal"> <a href="<?php echo base_url('project-details'); ?>" class="float-start">System Design</a> <span class="text-muted bg-light fs-12 mx-2">opened 2d ago</span> </h6>
																						<span class="text-muted border-end pe-2 fs-11 float-start mt-1">116 tasks</span>
																						<span class="text-teritary ps-1 fs-11">11 Nov 21</span>
																					</div>
																				</div>
