        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response.data, function(index, item) {
                    ...
                    var fullName = item.first_name + ' ' + item.last_name;
                    if (item.is_license == 0) {
                        item.is_license = '<span class="text-danger text-medium">rejected</span>'
                    } else {
                        item.is_license = '<span class="text-success text-medium">approved</span>'
                    }
