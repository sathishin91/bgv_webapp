							...
							<div class="row">
								<div class="col-xl-8 col-lg-7 col-md-12">
									<div class="card overflow-hidden">
										<a href="<?php echo base_url('blog-details'); ?>" class="card custom-card background-image-blog img1 mb-0">
										...
										<div class="card-body">
											...
											<a href="<?php echo base_url('blog-details'); ?>" class="btn btn-outline-primary mt-2">Read More</a>
										</div>
										<div class="card-footer">
											<div class="d-sm-flex align-items-center">
												<div class="avatar-list indicators">
													<a href="javascript:void(0)" class="avatar avatar-md rounded-circle cover-image" data-bs-image-src= "<?php echo base_url('assets/images/users/4.jpg'); ?>"></a>
												</div>
												...
												<div class="tab-content">
													<div class="tab-pane active" id="trending">
														<div class="item-list">
															<ul class="list-group mb-0">
																...
																<li class="list-group-item d-flex pb-4 pt-0 px-0 border-bottom-0">
																	<img src="<?php echo base_url('assets/images/photos/blog-sm5.jpg'); ?>" class="avatar br-5 avatar-lg me-3 my-auto" alt="avatar-img">
																	<div>
													...
													<div class="tab-pane" id="popular">
														<div class="item-list">
															<ul class="list-group mb-0">
																<li class="list-group-item d-flex pb-4 pt-0 px-0 border-bottom-0">
																	<img src="<?php echo base_url('assets/images/photos/blog1.jpg'); ?>" class="avatar br-5 avatar-lg me-3 my-auto" alt="avatar-img">
																	<div>
																		<span class="d-block text-muted">Tourism</span>
																		<a href="#" class="text-dark text-16 font-weight-semibold">Explore tourism by visitinig places.</a>
																		<small class="d-block text-muted">2 day ago</small>
											...
											<div class="row">
												<div class="col-xl-6 col-md-12 my-2 p-xl-max-0">
													<div class="card overflow-hidden box-shadow mb-0 main-blog">
														<a href="<?php echo base_url('blog-details'); ?>" class="background-image-blog img2 mb-0">
												...
												<div class="col-xl-6 col-md-12">
													<div class="row mb-5">
														<div class="col-xl-4 col-md-4 col-sm-4 pe-sm-0 p-sm-max-0">
															<a href="#">
																<img src="<?php echo base_url('assets/images/photos/blog-sug1.jpg'); ?>" alt="editor-picks" class="wp-100 editorpick-suggestion-img h-100">
															</a>
														</div>
													...
													<div class="row mb-5">
														<div class="col-xl-4 col-md-4 col-sm-4 pe-sm-0 p-sm-max-0">
															<a href="#">
																<img src="<?php echo base_url('assets/images/photos/blog-sug2.jpg'); ?>" alt="editor-picks" class="wp-100 editorpick-suggestion-img h-100">
															</a>
														</div>
														<div class="col-xl-8 col-md-8 col-sm-8 editorpicks-suggestions border p-2 br-sm-max-0">
													...
													<div class="row mb-5">
														<div class="col-xl-4 col-md-4 col-sm-4 pe-sm-0 p-sm-max-0">
															<a href="#">
																<img src="<?php echo base_url('assets/images/photos/blog-sug3.jpg'); ?>" alt="editor-picks" class="wp-100 editorpick-suggestion-img h-100">
															</a>
														</div>
														<div class="col-xl-8 col-md-8 col-sm-8 editorpicks-suggestions border p-2 br-sm-max-0">
													...
													<div class="row mb-5">
														<div class="col-xl-4 col-md-4 col-sm-4 pe-sm-0 p-sm-max-0">
															<a href="#">
																<img src="<?php echo base_url('assets/images/photos/blog-sug4.jpg'); ?>" alt="editor-picks" class="wp-100 editorpick-suggestion-img h-100">
															</a>
														</div>
														<div class="col-xl-8 col-md-8 col-sm-8 editorpicks-suggestions border p-2 br-sm-max-0">
													...
													<div class="row">
														<div class="col-xl-4 col-md-4 col-sm-4 pe-sm-0 p-sm-max-0">
															<a href="#">
																<img src="<?php echo base_url('assets/images/photos/blog-sug5.jpg'); ?>" alt="editor-picks" class="wp-100 editorpick-suggestion-img h-100">
															</a>
														</div>
														<div class="col-xl-8 col-md-8 col-sm-8 editorpicks-suggestions border p-2 br-sm-max-0">
											...
											<div class="row">
												<div class="col-xl-6 col-md-12">
													<div class="card overflow-hidden box-shadow mb-0 main-blog my-xl-0 my-2">
														<a href="<?php echo base_url('blog-details'); ?>" class="background-image-blog img3 mb-0">
												...
												<div class="col-xl-6 col-md-12">
													<div class="card overflow-hidden box-shadow mb-0 main-blog">
														<a href="<?php echo base_url('blog-details'); ?>" class="background-image-blog img4 mb-0">
										...
										<div class="card-body">
											<ul class="list-group blog-autors">
												<li class="list-group-item">
													<a href="#" class="text-dark-light">
														<div class="media mt-0 d-sm-flex d-block">
															<img class="avatar-md rounded-circle me-3 my-auto" src="<?php echo base_url('assets/images/faces/11.jpg'); ?>" alt="Image description">
												...
												<li class="list-group-item">
													<a href="#" class="text-dark-light">
														<div class="media mt-0 d-sm-flex d-block">
															<img class="avatar-md rounded-circle me-3 my-auto" src="<?php echo base_url('assets/images/faces/7.jpg'); ?>" alt="Image description">
															<div class="media-body d-sm-flex d-block">
																<div class="d-flex align-items-center">
																	<div class="mt-1">
												...
												<li class="list-group-item">
													<a href="#" class="text-dark-light">
														<div class="media mt-0 d-sm-flex d-block">
															<img class="avatar-md rounded-circle me-3 my-auto" src="<?php echo base_url('assets/images/faces/5.jpg'); ?>" alt="Image description">
															<div class="media-body d-sm-flex d-block">
																<div class="d-flex align-items-center">
																	<div class="mt-1">
												...
												<li class="list-group-item">
													<a href="#" class="text-dark-light">
														<div class="media mt-0 d-sm-flex d-block">
															<img class="avatar-md rounded-circle me-3 my-auto" src="<?php echo base_url('assets/images/faces/8.jpg'); ?>" alt="Image description">
												...
												<li class="list-group-item">
													<a href="#" class="text-dark-light">
														<div class="media mt-0 d-sm-flex d-block">
															<img class="avatar-md rounded-circle me-3 my-auto" src="<?php echo base_url('assets/images/faces/4.jpg'); ?>" alt="Image description">
															<div class="media-body">
																<div class="d-flex align-items-center">
																	<div class="mt-1">
												...
												<li class="list-group-item border-bottom-0">
													<a href="#" class="text-dark-light">
														<div class="media mt-0 d-sm-flex d-block">
															<img class="avatar-md rounded-circle me-3 my-auto" src="<?php echo base_url('assets/images/faces/2.jpg'); ?>" alt="Image description">
															<div class="media-body">
																<div class="d-flex align-items-center">
																	<div class="mt-1">
