...
<form action="<?php echo base_url('EmployeeController/editPanStatus') ?>" id="user_frm" method="post" enctype="multipart/form-data">
    <input type="hidden" class="form-control" id="id" name="id" value="<?= ($record) ? $record['id'] : '' ?>">

    <?php if ($record['is_pan'] == 1) {
        $status = "<span class='text-success'>approved</span>";
    } elseif ($record['is_pan'] == 2) {
    ...
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-3">
                <div style="text-align: left;">
                    <label for="first_name">PAN number</label>
                    <h6 class="text-black text-bold"><?= $record['pan'] ?></h6>
                </div>
...
<script>
    $("#saveDataBtn").click(function() {
        ...
        // alert(value);
        if (value == 1) {
            var str = "<input type='radio' name='status' value='1' id='status' class='selectgroup-input' checked> <span class='selectgroup-button'><i class='mdi mdi-approval text-success'></i> pan found</span>";
        } else if (value == 2) {
            ...
            var str = "<input type='radio' name='status' value='3' id='status' class='selectgroup-input' checked> <span class='selectgroup-button'><i class='mdi mdi-close-circle text-danger'></i> pan not found</span>";
        } else if (value == 4) {
            var str = "<input type='radio' name='status' value='4' id='status' class='selectgroup-input' checked> <span class='selectgroup-button'><i class='mdi mdi-close-circle text-danger'></i> pan found but name mismatched</span>";
        } else if (value == 5) {
            var str = "<input type='radio' name='status' value='5' id='status' class='selectgroup-input' checked> <span class='selectgroup-button'><i class='mdi mdi-close-circle text-danger'></i> fake pan</span>";
        }
