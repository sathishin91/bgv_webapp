															...
															<div class="carousel slide h-100" data-bs-interval="t" id="thumbcarousel">
																<div class="carousel-inner h-100">
																	<ul class="carousel-item active d-flex h-100">
																		<li class="thumb my-2" data-bs-slide-to="0" data-bs-target="#Slider"><img alt="img" src="<?php echo base_url('assets/images/pngs/6.png'); ?>"></li>
																		<li class="thumb my-2" data-bs-slide-to="1" data-bs-target="#Slider"><img alt="img" src="<?php echo base_url('assets/images/pngs/2.png'); ?>"></li>
																		<li class="thumb my-2 active" data-bs-slide-to="2" data-bs-target="#Slider"><img alt="img" src="<?php echo base_url('assets/images/pngs/3.png'); ?>"></li>
																		<li class="thumb my-2" data-bs-slide-to="3" data-bs-target="#Slider"><img alt="img" src="<?php echo base_url('assets/images/pngs/4.png'); ?>"></li>
																		<li class="thumb my-2" data-bs-slide-to="4" data-bs-target="#Slider"><img alt="img" src="<?php echo base_url('assets/images/pngs/9.png'); ?>"></li>
																	</ul>
																</div>
															</div>
														</div>
															...
															<div class="carousel slide h-100" data-bs-ride="false" id="Slider">
																<div class="carousel-inner h-100">
																	<div class="carousel-item">
																		<img alt="img" class="img-fluid w-100 d-block" src="<?php echo base_url('assets/images/pngs/6.png'); ?>">
																	</div>
																	<div class="carousel-item">
																		<img alt="img" class="img-fluid w-100 d-block" src="<?php echo base_url('assets/images/pngs/2.png'); ?>">
																	</div>
																	<div class="carousel-item active">
																		<img alt="img" class="img-fluid w-100 d-block" src="<?php echo base_url('assets/images/pngs/3.png'); ?>">
																	</div>
																	<div class="carousel-item">
																		<img alt="img" class="img-fluid w-100 d-block" src="<?php echo base_url('assets/images/pngs/4.png'); ?>">
																	</div>
																	<div class="carousel-item">
																		<img alt="img" class="img-fluid w-100 d-block" src="<?php echo base_url('assets/images/pngs/9.png'); ?>">
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="row">
															...
															<div class="col-auto d-flex align-items-center">
																<p class="mb-0 text-muted">
																	...
																	Deliver to Elena Gilbert.<a href="<?php echo base_url('checkout'); ?>" role="button" class="text-teritary mx-2">change</a>
																</p>
															</div>
														</div>
													</div>
																...
																<ul class="comment-section-main">
																	<li>
																		<div class="media mb-5 cnsl">
																			<div class=" me-3">
																				<a href="#"><img alt="64x64" class="media-object rounded-circle thumb-sm" src="<?php echo base_url('assets/images/users/5.jpg'); ?>"></a>
																			</div>
																	...
																	<li class="mb-0">
																		<div class="media mb-0">
																			<div class=" me-3">
																				<a href="#"><img alt="64x64" class="media-object rounded-circle thumb-sm" src="<?php echo base_url('assets/images/users/15.jpg'); ?>"></a>
																			</div>
																			<div class="media-body">
																				<div class="name-time-container d-flex">
									...
									<div class="col-md-12">
										<div class="card">
											<div class="card-body">
												...
												<form action="<?php echo base_url('index'); ?>" class="form-horizontal m-t-20">
