<?= $this->extend('layouts/main'); ?>
							...
							<div class="row">
								<div class="col-sm-12 col-md-12 col-xl-4">
									<div class="card custom-card">
										...
										<div class="card-body text-center">
											<img src="<?php echo base_url('assets/images/media/illustrate.png'); ?>" alt="counter-image" class="wd-300 ht-300 ">
								...
								<div class="col-sm-12 col-md-12 col-xl-4">
									<div class="card custom-card">
										...
										<div class="card-body text-center">
											<img src="<?php echo base_url('assets/images/media/illustrate1.png'); ?>" alt="counter-image" class="wd-300 ht-300 ">
								...
								<div class="col-sm-12 col-md-12 col-xl-4">
									<div class="card custom-card">
										...
										<div class="card-body text-center">
											<img src="<?php echo base_url('assets/images/media/illustrate2.png'); ?>" alt="counter-image" class="wd-300 ht-300 ">
	...
	<?= $this->section('scripts'); ?>
		...
		<!-- COUNT-DOWN JS-->
		<script src="<?php echo base_url('assets/plugins/counters/count-down.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/countdown/moment.min.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/countdown/moment-timezone.min.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/countdown/moment-timezone-with-data.min.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/countdown/countdowntime.js'); ?>"></script>
		...
		<script src="<?php echo base_url('assets/plugins/counters/counters-1.js'); ?>"></script>
