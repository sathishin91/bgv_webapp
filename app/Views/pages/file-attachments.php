											...
											<div class="h-100 attached-file-container">
												<div class="attached-file-image">
													<a href="javascript:void(0)">
														<img class="br-5 wp-100" src="<?php echo base_url('assets/images/media/1.jpg'); ?>" alt="attached-file-image"><span class="image-pic">123image.jpg</span>
													</a>
													<ul class="icons">
									...
									<div class="card custom-card">
										...
										<div class="card-body">
											<div class="h-100  attached-file-container">
												<div class="attached-file-image">
													<a href="javascript:void(0)">
														<img class="br-5 wp-100" src="<?php echo base_url('assets/images/media/2.jpg'); ?>" alt="attached-file-image"><span class="image-pic">123image.jpg</span>
													</a>
													<ul class="icons">
														<li class="me-1"><button type="button" class="btn btn-icon  btn-primary"><i class="fe fe-activity"></i></button></li>
														<li class="me-1"><button type="button" class="btn btn-icon  btn-primary"><i class="fe fe-trash"></i></button></li>
									...
									<div class="card custom-card">
										...
										<div class="card-body">
											<div class="h-100 attached-file-container">
												<div class="attached-file-image">
													<a href="javascript:void(0)">
														<img class="br-5 wp-100" src="<?php echo base_url('assets/images/media/3.jpg'); ?>" alt="attached-file-image"><span class="image-pic">123image.jpg</span>
													</a>
													<ul class="icons">
														<li class="me-1"><button type="button" class="btn btn-icon  btn-primary"><i class="fe fe-activity"></i></button></li>
														<li class="me-1"><button type="button" class="btn btn-icon  btn-primary"><i class="fe fe-trash"></i></button></li>
										...
										<div class="card-body">
											<div class="h-100  attached-file-container">
												<div class="pro-img-box attached-file-image">
													<a href="javascript:void(0)">
														<img class="br-5 wp-100" src="<?php echo base_url('assets/images/media/4.jpg'); ?>" alt="attached-file-image"><span class="image-pic">123image.jpg</span>
													</a>
													<ul class="icons">
														<li class="me-1"><button type="button" class="btn btn-icon  btn-primary"><i class="fe fe-activity"></i></button></li>
														<li class="me-1"><button type="button" class="btn btn-icon  btn-primary"><i class="fe fe-trash"></i></button></li>
