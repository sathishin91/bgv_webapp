<?= $this->extend('layouts/main'); ?>
	...
	<?= $this->section('scripts'); ?>
		...
		<!-- TABLE EDITS JS-->
		<script src="<?php echo base_url('assets/plugins/jQuery-table-edits/table-edits.min.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/jQuery-table-edits/table-edits.js'); ?>"></script>
