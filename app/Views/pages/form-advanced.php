<?= $this->extend('layouts/main'); ?>
												...
												<div class="row row-sm">
													<div class="col-lg-4 mb-3">
														...
														<div class="input-group">
															...
															<input class="form-control" id="datepicker-date" placeholder="DD-MM-YYYY" type="text">
														</div><!-- input-group -->
													</div><!-- col-4 -->
													<div class="col-lg-4 mb-3">
														...
														<div class="input-group">
															...
															<input class="form-control" id="datepicker-month" placeholder="MONTH" type="text">
														</div><!-- input-group -->
													</div>
													<div class="col-lg-4 mb-3">
														...
														<div class="input-group">
															...
															<input class="form-control" id="datepicker-year" placeholder="YEAR" type="text">
														</div><!-- input-group -->
													</div>
												</div>
											</div>
														...
														<div class="row">
															<div class="col-lg-6 mb-3">
																...
																<div class="input-group">
																	...
																	<input class="form-control fc-datepicker" id="fc-datepicker" placeholder="DD/MM/YYYY" type="text">
																</div><!-- input-group -->
															</div><!-- col-6 -->
															<div class="col-lg-6 mb-3">
																...
																<div class="input-group">
																	...
																	<input class="form-control" id="datepickerNoOfMonths" placeholder="DD/MM/YYYY" type="text">
																</div><!-- input-group -->
															</div><!-- col-6 -->
														</div>
													</div>
									...
									<div class="card">
										...
										<div class="card-body">
											...
											<div class="row mb-4">
												...
												<div class="col-sm-12 col-md-4  mb-4 mb-lg-0">
													<input type="file" class="dropify" data-default-file="<?php echo base_url('assets/images/photos/1.jpg'); ?>" data-height="200"  />
												</div>
												<div class="col-sm-12 col-md-4  mb-4 mb-lg-0">
	...
	<?= $this->section('scripts'); ?>
		...
		<!-- BOOTSTRAP-DATEPICKER JS (DATEPICKER STYLE-01)  -->
		...
		<script src="<?php echo base_url('assets/plugins/bootstrap-maxlength/dist/bootstrap-maxlength.min.js'); ?>"></script>
