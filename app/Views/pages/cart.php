												...
												<table class="table table-bordered table-vcenter text-nowrap mb-0">
													...
													<tbody>
														...
														<tr>
															...
															<td>
																<img src="<?php echo base_url('assets/images/pngs/5.png'); ?>" alt="" class="cart-img">
															</td>
									...
									<div class="card">
										...
										<div class="card-footer">
											<div class="step-footer text-end">
												<a href="<?php echo base_url('products'); ?>" class="btn btn-primary my-1">
												...
												<a href="<?php echo base_url('checkout'); ?>" class="btn btn-info my-1">
													Check out
