												...
												<div class="row mt-4">
													<div class="col-md-6 col-xl-3">
														<a href="#" class="thumbnail ">
															<img src="<?php echo base_url('assets/images/media/16.jpg'); ?>" alt="thumb1" class="thumbimg">
														</a>
													</div>
													<div class="col-md-6 col-xl-3">
														<a href="#" class="thumbnail">
															<img src="<?php echo base_url('assets/images/media/media2.jpg'); ?>" alt="thumb1" class="thumbimg">
														</a>
													</div>
													<div class="col-md-6 col-xl-3">
														<a href="#" class="thumbnail">
															<img src="<?php echo base_url('assets/images/media/media3.jpg'); ?>" alt="thumb1" class="thumbimg">
														</a>
													</div>
													<div class="col-md-6 col-xl-3">
														<a href="#" class="thumbnail">
															<img src="<?php echo base_url('assets/images/media/media4.jpg'); ?>" alt="thumb1" class="thumbimg">
														</a>
													</div>
												</div>
											</div>
											...
											<div class="example">
												<div class="row mt-4">
													<div class="col-md-12 col-xl-4">
														<div class="thumbnail">
															<a href="#">
																<img src="<?php echo base_url('assets/images/media/21.jpg'); ?>" alt="thumb1" class="thumbimg">
															</a>
															<div class="caption">
													...
													<div class="col-md-12 col-xl-4">
														<div class="thumbnail">
															<a href="#">
																<img src="<?php echo base_url('assets/images/media/12.jpg'); ?>" alt="thumb1" class="thumbimg">
															</a>
															<div class="caption">
																<h4>Thumbnail label</h4>
													...
													<div class="col-md-12 col-xl-4">
														<div class="thumbnail">
															<a href="#">
																<img src="<?php echo base_url('assets/images/media/13.jpg'); ?>" alt="thumb1" class="thumbimg">
															</a>
															<div class="caption">
																<h4>Thumbnail label</h4>
											...
											<div class="example">
												<div class="row mt-4">
													<div class="col-md-12 col-lg-6 col-xl-3">
														<div class="thumbnail">
															<a href="#">
																<img src="<?php echo base_url('assets/images/media/4.jpg'); ?>" alt="thumb1" class="thumbimg">
															</a>
															<div class="caption">
																<h4>Thumbnail label</h4>
													...
													<div class="col-md-12 col-lg-6 col-xl-3">
														<div class="thumbnail">
															<a href="#">
																<img src="<?php echo base_url('assets/images/media/5.jpg'); ?>" alt="thumb1" class="thumbimg">
															</a>
															<div class="caption">
																<h4>Thumbnail label</h4>
													...
													<div class="col-md-12 col-lg-6 col-xl-3">
														<div class="thumbnail">
															...
															<a href="#">
																<img src="<?php echo base_url('assets/images/media/6.jpg'); ?>" alt="thumb1" class="thumbimg">
															</a>
														</div>
													</div>
													<div class="col-md-12 col-lg-6 col-xl-3">
														<div class="thumbnail">
															...
															<a href="#">
																<img src="<?php echo base_url('assets/images/media/7.jpg'); ?>" alt="thumb1" class="thumbimg">
															</a>
														</div>
													</div>
												</div>
											...
											<div class="example">
												...
												<div class="row mt-4 justify-content-start">
													<div class="col-md-12 col-lg-6 col-xl-3">
														<div class="thumbnail">
															<a href="#">
																<img src="<?php echo base_url('assets/images/media/14.jpg'); ?>" alt="thumb1" class="thumbimg">
															</a>
															<div class="caption">
																<h4>Thumbnail label</h4>
													...
													<div class="col-md-12 col-lg-6 col-xl-3">
														<div class="thumbnail">
															<a href="#">
																<img src="<?php echo base_url('assets/images/media/15.jpg'); ?>" alt="thumb1" class="thumbimg">
															</a>
															<div class="caption">
																<h4>Thumbnail label</h4>
