									...
									<div class="row mt-5">
										<div class="col-lg-3 col-sm-6 why-image">
											<div class="card">
												<div class="card-body">
													<div class="mb-2">
														<img class="img-fluid" src="<?php echo base_url('assets/images/landing/Why/web-designing.png'); ?>" alt="">
													</div>
										...
										<div class="col-lg-3 col-sm-6 why-image">
											<div class="card">
												<div class="card-body">
													<div class="mb-2">
														<img class="img-fluid" src="<?php echo base_url('assets/images/landing/Why/documentation.png'); ?>" alt="">
													</div>
										...
										<div class="col-lg-3 col-sm-6 why-image">
											<div class="card">
												<div class="card-body">
													<div class="mb-2">
														<img class="img-fluid" src="<?php echo base_url('assets/images/landing/Why/web-settings.png'); ?>" alt="">
													</div>
										...
										<div class="col-lg-3 col-sm-6 why-image">
											<div class="card">
												<div class="card-body">
													<div class="mb-2">
														<img class="img-fluid" src="<?php echo base_url('assets/images/landing/Why/update.png'); ?>" alt="">
													</div>
												...
												<div class="slide">
													<div class="row align-items-center">
														...
														<div class="col-md-5 col-12">
															<img class="img-fluid float-md-end" src="<?php echo base_url('assets/images/landing/desktop.png'); ?>" alt="">
														</div>
													</div>
												</div>
												<div class="slide">
													<div class="row align-items-center">
														...
														<div class="col-md-5 col-sm-12">
															<img class="img-fluid float-md-end" src="<?php echo base_url('assets/images/landing/laptop.png'); ?>" alt="">
														</div>
													</div>
												</div>
												<div class="slide">
													<div class="row align-items-center">
														...
														<div class="col-md-5 col-sm-12">
															<img class="img-fluid float-md-end" src="<?php echo base_url('assets/images/landing/tablet.png'); ?>" alt="">
														</div>
													</div>
												</div>
												<div class="slide">
													<div class="row align-items-center">
														...
														<div class="col-md-5 col-sm-12">
															<img class="img-fluid float-md-end" src="<?php echo base_url('assets/images/landing/mobile.png'); ?>" alt="">
														</div>
													</div>
												</div>
											</div>
								...
								<div class="container px-5 px-md-0">
									...
									<div class="row align-items-center">
										<div class="col-xl-5 customize-image text-center">
											<img class="img-fluid p-5" src="<?php echo base_url('assets/images/landing/customize.png'); ?>" alt="">
										</div>
									...
									<div class="row justify-content-center">
										<div class="col-lg-12">
											<div class="customer-logos">
												<div class="slide"><img src="<?php echo base_url('assets/images/landing/companies/apple.png'); ?>" alt=""></div>
												<div class="slide"><img src="<?php echo base_url('assets/images/landing/companies/chrome.png'); ?>" alt=""></div>
												<div class="slide"><img src="<?php echo base_url('assets/images/landing/companies/google.png'); ?>" alt=""></div>
												<div class="slide"><img src="<?php echo base_url('assets/images/landing/companies/edge.png'); ?>" alt=""></div>
												<div class="slide"><img src="<?php echo base_url('assets/images/landing/companies/firefox.png'); ?>" alt=""></div>
												<div class="slide"><img src="<?php echo base_url('assets/images/landing/companies/opera.png'); ?>" alt=""></div>
												<div class="slide"><img src="<?php echo base_url('assets/images/landing/companies/safari.png'); ?>" alt=""></div>
												<div class="slide"><img src="<?php echo base_url('assets/images/landing/companies/bing.png'); ?>" alt=""></div>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row text-center team">
										<div class="col-lg-3 col-sm-6 mb-5">
											<div class="bg-white shadow-sm p-5 team-card"><img
													src="<?php echo base_url('assets/images/landing/team/1.jpg'); ?>" alt=""
										...
										<div class="col-lg-3 col-sm-6 mb-5">
											<div class="bg-white shadow-sm p-5 team-card"><img
													src="<?php echo base_url('assets/images/landing/team/2.jpg'); ?>" alt="" width="100"
													class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
										...
										<div class="col-lg-3 col-sm-6 mb-5">
											<div class="bg-white shadow-sm p-5 team-card"><img
													src="<?php echo base_url('assets/images/landing/team/3.jpg'); ?>" alt="" width="100"
													class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
										...
										<div class="col-lg-3 col-sm-6 mb-5">
											<div class="bg-white shadow-sm p-5 team-card"><img
													src="<?php echo base_url('assets/images/landing/team/4.jpg'); ?>" alt="" width="100"
													class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
												...
												<div class="statistics-info">
													<div class="col-xl-12 col-12">
														<div class="row">
															...
															<div class="col-xl-6 col-md-12 col-sm-12">
																<div class="">
																	<form class="form-horizontal  m-t-20 row">
																		<div class="col-xl-6">
