...
<div class="page-header">
    <div>
        <h1 class="page-title">Todo's - Aadhar</h1>
    </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><span>
                                                    <a href="javascript:void(0)" onclick="todoAadharModal(<?= $record['id'] ?>)"><i class="fa fa-arrow-right"></i></a>
                                                    <!-- <a href="<?php echo base_url("EmployeeController/aadharDashboard?id=$id"); ?>"><i class="fa fa-arrow-right"></i></a> -->
                                                </span>
                                            </td>
                                        </tr>
                                    <?php endforeach;
...
<script>
    ...
    $('#filterStatus').on('change', function() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url('EmployeeController/filterAadharStatus') ?>',
            data: {
                filter: selectedValue
            },
            dataType: 'json',
