<?= $this->extend('layouts/main'); ?>
	...
	<?= $this->section('scripts'); ?>
		...
		<script src="<?php echo base_url('assets/plugins/notify/js/rainbow.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/notify/js/sample.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/notify/js/jquery.growl.js'); ?>"></script>
