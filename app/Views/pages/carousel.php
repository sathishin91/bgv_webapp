											...
											<div id="carousel-default" class="carousel slide" data-bs-ride="carousel">
												<div class="carousel-inner">
													<div class="carousel-item active">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/9.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/7.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/5.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/1.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/3.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
												</div>
											</div>
										</div>
									...
									<div class="card">
										...
										<div class="card-body h-100">
											<div id="carousel-indicators" class="carousel slide" data-bs-ride="carousel">
												...
												<div class="carousel-inner">
													<div class="carousel-item active">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/2.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/4.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/6.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/8.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/10.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
												</div>
											</div>
										</div>
									...
									<div class="card">
										...
										<div class="card-body h-100">
											<div id="carousel-controls" class="carousel slide" data-bs-ride="carousel">
												<div class="carousel-inner">
													<div class="carousel-item active">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/11.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/13.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/15.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/17.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/19.jpg'); ?>" data-bs-holder-rendered="true">
													</div>
												</div>
									...
									<div class="card">
										...
										<div class="card-body h-100">
											<div id="carousel-captions" class="carousel slide" data-bs-ride="carousel">
												<div class="carousel-inner">
													<div class="carousel-item active">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/12.jpg'); ?>" data-bs-holder-rendered="true">
													...
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/14.jpg'); ?>" data-bs-holder-rendered="true">
														<div class="carousel-item-background d-none d-md-block"></div>
														<div class="carousel-caption d-none d-md-block">
															<h3>Slide label</h3>
															<p>Secure other greater pleasures</p>
													...
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/16.jpg'); ?>" data-bs-holder-rendered="true">
														<div class="carousel-item-background d-none d-md-block"></div>
														<div class="carousel-caption d-none d-md-block">
															<h3>Slide label</h3>
															<p>Secure other greater pleasures</p>
													...
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/18.jpg'); ?>" data-bs-holder-rendered="true">
														<div class="carousel-item-background d-none d-md-block"></div>
														<div class="carousel-caption d-none d-md-block">
															<h3>Slide label</h3>
															<p>Secure other greater pleasures</p>
													...
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/20.jpg'); ?>" data-bs-holder-rendered="true">
														<div class="carousel-item-background d-none d-md-block"></div>
														<div class="carousel-caption d-none d-md-block">
															<h3>Slide label</h3>
															<p>Secure other greater pleasures</p>
									...
									<div class="card">
										...
										<div class="card-body h-100">
											<div id="carousel-captions2" class="carousel slide" data-bs-ride="carousel">
												<div class="carousel-inner">
													<div class="carousel-item active">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/red.jpg'); ?>" data-bs-holder-rendered="true">
													...
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/blue.jpg'); ?>" data-bs-holder-rendered="true">
														<div class="carousel-item-background d-none d-md-block"></div>
														<div class="carousel-caption d-none d-md-block">
															<h3>Slide label</h3>
															<p>The wise man therefore always holds in these matters to this principle of selection he rejects pleasures.</p>
													...
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/green.jpg'); ?>" data-bs-holder-rendered="true">
														<div class="carousel-item-background d-none d-md-block"></div>
														<div class="carousel-caption d-none d-md-block">
															<h3>Slide label</h3>
															<p>The wise man therefore always holds in these matters to this principle of selection he rejects pleasures.</p>
									...
									<div class="card">
										...
										<div class="card-body h-100">
											<div id="carousel-captions1" class="carousel slide" data-bs-ride="carousel">
												<div class="carousel-inner">
													<div class="carousel-item active">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/gradient1.jpg'); ?>" data-bs-holder-rendered="true">
														<div class="carousel-caption">
															<h3>Slide label</h3>
															<p>The wise man therefore always holds in these matters to this principle of selection: he rejects pleasures.</p>
														</div>
													...
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/gradient2.jpg'); ?>" data-bs-holder-rendered="true">
														<div class="carousel-item-background d-none d-md-block"></div>
														<div class="carousel-caption d-none d-md-block">
															<h3>Slide label</h3>
															<p>The wise man therefore always holds in these matters to this principle of selection he rejects pleasures.</p>
													...
													<div class="carousel-item">
														<img class="d-block w-100" alt="" src="<?php echo base_url('assets/images/media/gradient3.jpg'); ?>" data-bs-holder-rendered="true">
														<div class="carousel-item-background d-none d-md-block"></div>
														<div class="carousel-caption d-none d-md-block">
															<h3>Slide label</h3>
															<p>The wise man therefore always holds in these matters to this principle of selection he rejects pleasures.</p>
