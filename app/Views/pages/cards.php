							...
							<div class="row">
								...
								<div class="col-md-12 col-xl-4">
									<div class="card ">
										...
										<div class="card-body text-center">
											<span class="avatar avatar-xxl brround cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/18.jpg'); ?>"></span>
								...
								<div class="col-md-12 col-xl-4">
									<div class="card ">
										...
										<div class="card-body text-center">
											<span class="avatar avatar-xxl brround cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/8.jpg'); ?>"></span>
										...
										<div class="card-body">
											<div class="visitor-list">
												<div class="media m-0 mt-0 border-bottom">
													<img class="avatar brround avatar-md me-3" alt="avatra-img" src="<?php echo base_url('assets/images/users/18.jpg'); ?>">
												...
												<div class="media mt-2 border-bottom">
													<img class="avatar brround avatar-md me-3" alt="avatra-img" src="<?php echo base_url('assets/images/users/20.jpg'); ?>">
													<div class="media-body">
