<?= $this->extend('layouts/main'); ?>
                                        ...
                                        <div class="main-content-app pt-0">
                                            <div class="main-content-left main-content-left-chat">
                                                <div class="card-body d-flex">
                                                    <div class="main-img-user online"><img alt="avatar" src="<?php echo base_url('assets/images/faces/6.jpg'); ?>"></div>
                                                            ...
                                                            <div class="main-chat-contacts-slider lSSlideWrapper usingCss overflow-scroll">
                                                                <div class="main-chat-contacts lightSlider lsGrab lSSlide ps-0" id="chatActiveContacts" style="width: 464px; height: 59px; padding-bottom: 0%;">
                                                                    <div class="lslide active">
                                                                        <span class="avatar avatar-md bradius cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/5.jpg'); ?>" style="background: url(&quot;<?php echo base_url('assets/images/users/5.jpg'); ?>&quot;) center center;">
                                                                <span class="avatar-status bg-green"></span>
                                                                        </span><small>Ariana</small>
                                                                    </div>
                                                                    <div class="lslide">
                                                                        <span class="avatar avatar-md bradius cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/9.jpg'); ?>" style="background: url(&quot;<?php echo base_url('assets/images/users/9.jpg'); ?>&quot;) center center;">
                                                                <span class="avatar-status bg-green"></span>
                                                                        </span><small>Monino</small>
                                                                    </div>
                                                                    <div class="lslide">
                                                                        <span class="avatar avatar-md bradius cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/6.jpg'); ?>" style="background: url(&quot;<?php echo base_url('assets/images/users/6.jpg'); ?>&quot;) center center;">
                                                                <span class="avatar-status bg-green"></span>
                                                                        </span><small>Reynante</small>
                                                                    </div>
                                                                    <div class="lslide">
                                                                        <span class="avatar avatar-md bradius cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/7.jpg'); ?>" style="background: url(&quot;<?php echo base_url('assets/images/users/7.jpg'); ?>&quot;) center center;">
                                                                <span class="avatar-status bg-green"></span>
                                                ...
                                                <div class="tab-content main-chat-list flex-2">
                                                        ...
                                                        <div class="main-chat-list tab-pane">
                                                            <a class="media new border-top-0" href="#">
                                                                <div class="main-img-user online">
                                                                    <img alt="" src="<?php echo base_url('assets/images/users/5.jpg'); ?>">
                                                                </div>
                                                            ...
                                                            <a class="media new" href="#">
                                                                <div class="main-img-user">
                                                                    <img alt="" src="<?php echo base_url('assets/images/users/6.jpg'); ?>"> <span>3</span>
                                                                </div>
                                                                <div class="media-body">
                                                                    <div class="media-contact-name">
                                                            ...
                                                            <a class="media selected" href="#">
                                                                <div class="main-img-user online"><img alt="" src="<?php echo base_url('assets/images/users/9.jpg'); ?>"></div>
                                                                <div class="media-body">
                                                                    <div class="media-contact-name">
                                                            ...
                                                            <a class="media new" href="#">
                                                                <div class="main-img-user"><img alt="" src="<?php echo base_url('assets/images/users/4.jpg'); ?>"></div>
                                                                <div class="media-body">
                                                                    <div class="media-contact-name">
                                                            ...
                                                            <a class="media new" href="#">
                                                                <div class="main-img-user"><img alt="" src="<?php echo base_url('assets/images/users/20.jpg'); ?>"></div>
                                                                <div class="media-body">
                                                                    <div class="media-contact-name">
                                                            ...
                                                            <a class="media new" href="#">
                                                                <div class="main-img-user"><img alt="" src="<?php echo base_url('assets/images/users/5.jpg'); ?>"></div>
                                                                <div class="media-body">
                                                                    <div class="media-contact-name">
                                                            ...
                                                            <a class="media new" href="#">
                                                                <div class="main-img-user"><img alt="" src="<?php echo base_url('assets/images/users/3.jpg'); ?>"></div>
                                                                <div class="media-body">
                                                                    <div class="media-contact-name">
                                                            ...
                                                            <a class="media new" href="#">
                                                                <div class="main-img-user"><img alt="" src="<?php echo base_url('assets/images/users/7.jpg'); ?>"></div>
                                                                <div class="media-body">
                                                                    <div class="media-contact-name">
                                                            ...
                                                            <a class="media border-bottom-0" href="#">
                                                                <div class="main-img-user"><img alt="" src="<?php echo base_url('assets/images/users/6.jpg'); ?>"></div>
                                                                <div class="media-body">
                                                                    <div class="media-contact-name">
                                                    ...
                                                    <div class="tab-pane" id="ChatGroups">
                                                        <a href="#" class="d-flex align-items-center media border-top-0">
                                                            <div class="mb-0 me-2">
                                                                <div class="main-img-user online text-primary">
                                                                    <img alt="" src="<?php echo base_url('assets/images/users/4.jpg'); ?>"> <span>2</span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <a href="#" class="d-flex align-items-center media">
                                                            <div class="mb-0 me-2">
                                                                <div class="main-img-user online">
                                                                    <img alt="" src="<?php echo base_url('assets/images/users/9.jpg'); ?>"> <span>2</span>
                                                                </div>
                                                            </div>
                                                            <div class="align-items-center justify-content-between">
                                                                <div class="media-body ms-2">
                                                        ...
                                                        <a href="#" class="d-flex align-items-center media">
                                                            <div class="mb-0 me-2">
                                                                <div class="main-img-user online">
                                                                    <img alt="" src="<?php echo base_url('assets/images/users/12.jpg'); ?>"> <span>2</span>
                                                                </div>
                                                            </div>
                                                            <div class="align-items-center justify-content-between">
                                                                <div class="media-body ms-2">
                                                        ...
                                                        <a href="#" class="d-flex align-items-center media">
                                                            <div class="mb-0 me-2">
                                                                <div class="main-img-user online">
                                                                    <img alt="" src="<?php echo base_url('assets/images/users/6.jpg'); ?>"> <span>2</span>
                                                                </div>
                                                            </div>
                                                            <div class="align-items-center justify-content-between">
                                                                <div class="media-body ms-2">
                                                        ...
                                                        <a href="#" class="d-flex align-items-center media">
                                                            <div class="mb-0 me-2">
                                                                <div class="main-img-user online">
                                                                    <img alt="" src="<?php echo base_url('assets/images/users/7.jpg'); ?>"> <span>2</span>
                                                                </div>
                                                            </div>
                                                            <div class="align-items-center justify-content-between">
                                                                <div class="media-body ms-2">
                                                    ...
                                                    <div class="tab-pane" id="ChatContacts">
                                                        <div>
                                                            ...
                                                            <a href="#" class="d-flex align-items-center media">
                                                                <div class="mb-0 me-2">
                                                                    <div class="main-img-user online">
                                                                        <img alt="" src="<?php echo base_url('assets/images/users/3.jpg'); ?>"> <span>2</span>
                                                                    </div>
                                                                </div>
                                                                <div class="align-items-center justify-content-between">
                                                                    <div class="media-body ms-2">
                                                        ...
                                                        <div class="mt-4">
                                                            ...
                                                            <a href="#" class="d-flex align-items-center media">
                                                                <div class="mb-0 me-2">
                                                                    <div class="main-img-user online">
                                                                        <img alt="" src="<?php echo base_url('assets/images/users/5.jpg'); ?>"> <span>2</span>
                                                                    </div>
                                                                </div>
                                                                <div class="align-items-center justify-content-between">
                                                                    <div class="media-body ms-2">
                                                        ...
                                                        <div class="mt-4">
                                                            ...
                                                            <a href="#" class="d-flex align-items-center media">
                                                                <div class="mb-0 me-2">
                                                                    <div class="main-img-user online">
                                                                        <img alt="" src="<?php echo base_url('assets/images/users/20.jpg'); ?>"> <span>2</span>
                                                                    </div>
                                                                </div>
                                                                <div class="align-items-center justify-content-between">
                                                                    <div class="media-body ms-2">
                                                            ...
                                                            <a href="#" class="d-flex align-items-center media">
                                                                <div class="mb-0 me-2">
                                                                    <div class="main-img-user online">
                                                                        <img alt="" src="<?php echo base_url('assets/images/users/2.jpg'); ?>"> <span>2</span>
                                                                    </div>
                                                                </div>
                                                                <div class="align-items-center justify-content-between">
                                                                    <div class="media-body ms-2">
                                                        ...
                                                        <div class="mt-4">
                                                            ...
                                                            <a href="#" class="d-flex align-items-center media">
                                                                <div class="mb-0 me-2">
                                                                    <div class="main-img-user online">
                                                                        <img alt="" src="<?php echo base_url('assets/images/users/1.jpg'); ?>"> <span>2</span>
                                                                    </div>
                                                                </div>
                                                                <div class="align-items-center justify-content-between">
                                                                    <div class="media-body ms-2">
                                        ...
                                        <div class="main-content-app pt-0">
                                            <div class="main-content-body main-content-body-chat h-100">
                                                <div class="main-chat-header pt-3 d-block d-sm-flex">
                                                    <div class="main-img-user online"><img alt="avatar" src="<?php echo base_url('assets/images/users/1.jpg'); ?>"></div>
                                                ...
                                                <div class="main-chat-body flex-2" id="ChatBody">
                                                    <div class="content-inner">
                                                        ...
                                                        <div class="media flex-row-reverse chat-right">
                                                            <div class="main-img-user online"><img alt="avatar" src="<?php echo base_url('assets/images/users/20.jpg'); ?>"></div>
                                                            <div class="media-body">
                                                        ...
                                                        <div class="media chat-left">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <div class="main-msg-wrapper">
                                                                    <img alt="avatar" class="w-10 h-10" src="<?php echo base_url('assets/images/media/3.jpg'); ?>">
                                                                    <img alt="avatar" class="w-10 h-10" src="<?php echo base_url('assets/images/media/4.jpg'); ?>">
                                                                    <img alt="avatar" class="w-10 h-10" src="<?php echo base_url('assets/images/media/5.jpg'); ?>">
                                                                </div>
                                                                <div>
                                            ...
                                            <div class="main-content-app">
                                                ...
                                                <div class="text-center chat-image p-4 pb-0 mb-4 br-5">
                                                    <div class="rounded-circle chat-profile">
                                                        <a class="rounded-circle" href="<?php echo base_url('profile'); ?>"><img alt="profile-avatar" src="<?php echo base_url('assets/images/users/1.jpg'); ?>" class="avatar avatar-xl rounded-circle"></a>
                                                    </div>
                                                    <div class="main-chat-msg-name">
                                                    ...
                                                    <div class="row row-sm chat-media">
                                                        <div class="col-xl-4 col-lg-2 col-md-3 col-4">
                                                            <div class="card custom-card border br-5">
                                                                <img src="<?php echo base_url('assets/images/files/doc.png'); ?>" alt="img" class="br-5">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-4 col-lg-2 col-md-3 col-4">
                                                            <div class="card custom-card border br-5">
                                                                <img src="<?php echo base_url('assets/images/files/file.png'); ?>" alt="img" class="br-5">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-4 col-lg-2 col-md-3 col-4">
                                                            <div class="card custom-card border br-5">
                                                                <img src="<?php echo base_url('assets/images/files/image.png'); ?>" alt="img" class="br-5">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-4 col-lg-2 col-md-3 col-4">
                                                            <div class="card custom-card border br-5">
                                                                <img src="<?php echo base_url('assets/images/files/ppt.png'); ?>" alt="img" class="br-5">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-4 col-lg-2 col-md-3 col-4">
                                                            <div class="card custom-card border br-5">
                                                                <img src="<?php echo base_url('assets/images/files/word.png'); ?>" alt="img" class="br-5">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-4 col-lg-2 col-md-3 col-4">
                                                            <div class="card custom-card border br-5">
                                                                <img src="<?php echo base_url('assets/images/files/zip.png'); ?>" alt="img" class="br-5">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
	...
	<?= $this->section('scripts'); ?>
		...
		<script src="<?php echo base_url('assets/plugins/tabs/tab-content.js'); ?>"></script>
